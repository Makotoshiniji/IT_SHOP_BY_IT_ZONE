...
# ============================================ CONTACT Button ============================================ #
        ...
        self.CONTACT_ICON = QPushButton()  # ปุ่มที่มีข้อความ
        self.CONTACT_ICON.setIcon(QIcon("assets/image/CONTACT icon.png"))  # เปลี่ยน path ให้ถูกต้องกับไฟล์ไอคอนของคุณ
        self.CONTACT_ICON.setIconSize(QSize(40, 40))  # ขนาดไอคอน
        self.CONTACT_ICON.setStyleSheet("""
            QPushButton {
                color: white;
                background-color: #295CA5;
                border: none;
        ...
        """)
        self.CONTACT_ICON.clicked.connect(self.go_to_contactus)
        self.SideBar_Area.addWidget(self.CONTACT_ICON)
...
# ========================= สร้าง Wrapper Widget สำหรับ Product Summary ========================= #
    ...
    def setup_total_amount(self):
        ...
        try:
            ...
            if hasattr(self, "total_amount_label"):
                ...
                self.total_amount_label = QtWidgets.QLabel(total_amount)

                total_text_label.setStyleSheet("QLabel {color: black;}")
                self.total_amount_label.setStyleSheet("QLabel {color: black;}")
    ...
    def apply_discount(self):
        ...
        discount_code = self.discount_code_input.text().strip()
    ...
    #         self.net_amount_label = QtWidgets.QLabel(net_amount)  # ตั้งค่า QLabel ด้วยค่าเริ่มต้น
    #         self.net_amount_label.setStyleSheet("QLabel {color: black;}")
...
# ============================================ EXIT Button ============================================ #
    ...
    # ========================= สร้าง หน้าแสดงรายการสินค้า ============================= #
        # products = [
        #     {"image": "image/HEADPHONE V1.png", "name": "AULA S608 GAMING\nHEADSET 3.5MM+USB\n(BLACK) (2Y)", "price": "฿330"},
        #     {"image": "image/HEADPHONE V2.png", "name": "ONIKUMA X13 RGB\n3.5MM (PINK) (2Y)", "price": "฿690"},
        #     {"image": "image/HEADPHONE V3.png", "name": "ONIKUMA HOTARU\nGAMING HEADPHONE 7.1\n(BLACK)", "price": "฿799"},
        #     {"image": "image/HEADPHONE V4.png", "name": "ONIKUMA X25 HOTARU\nGAMING HEADPHONE 7.1\n(WHITE) (2Y)", "price": "฿890"},
        #     {"image": "image/HEADPHONE V5.png", "name": "HYPER X CLOUD MINI\nBLACK (7G8F4AA)", "price": "฿1,090"},
        #     {"image": "image/HEADPHONE V6.png", "name": "HyperX CLOUD EARBUDS\nII - RED (705L8AA)", "price": "฿1,490"},
        #     {"image": "image/HEADPHONE V7.png", "name": "LOGA PHOTON :\nIN EAR MONITORS\n(PRINTSTREAM) (2Y)", "price": "฿1,890"},
        #     {"image": "image/HEADPHONE V8.png", "name": "HyperX CLOUD MIX BUDS\n2 : BLACK (7D0A4AA) (2Y)", "price": "฿5,790"},
        # ]
